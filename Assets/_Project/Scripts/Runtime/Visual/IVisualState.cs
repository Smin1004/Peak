...
namespace Peak.Visual
{
    ...
    /// M0-2 는 색, M0-3 은 1인칭 자기 몸 숨김. 이동 상태 표현(등반 = 벽에 붙음, 기절 = 눕힘 …)은 M1 이 메서드를 추가한다.
    /// </summary>
    public interface IVisualState
    {
        ...
        /// <summary>
        /// 오너 로컬 화면이면 true — 몸은 그림자만 렌더한다 (1인칭, Docs/202_gameplay.md 12.2). 다른 플레이어 인스턴스는 false (정상 렌더).
        /// 그림자는 발 위치·고도감 단서라 남긴다.
        /// </summary>
        void SetLocalView(bool isLocalView);
    }
}
